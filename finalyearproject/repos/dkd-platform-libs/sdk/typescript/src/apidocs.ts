...
// PL-08: pin to the source-of-truth OpenAPI version (sdk/openapi/dkd-platform.openapi.json is
// 3.1.0) — fixes the 3.0.1/3.0.3/3.1 drift across the five language SDKs.
