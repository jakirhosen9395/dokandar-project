...
> DOKANDAR **b2c** service — generated by `dkd-scaffold` from the canonical service blueprint.
> **Infrastructure only — no business logic.** Runtime: **node**. Consumes `dkd-platform-libs` (`@dokandar/platform-sdk`).
