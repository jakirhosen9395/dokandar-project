"""Alembic env — sync driver (psycopg2) using the service POSTGRES_DSN."""
from logging.config import fileConfig
from sqlalchemy import engine_from_config, pool
from alembic import context
from app.config import settings
from app.db.models import Base  # noqa  — registers metadata
...
# Convert SQLAlchemy async DSN to a sync one for Alembic
def _sync_dsn() -> str:
